...
// // function Square( { id, props, onToggle, isSet }) {
// //     return (
// //         <div 
// //             className={`square ${isSet ? "square--set" : ""}`}
// //             onClick={onToggle}
// //             >
// //                 {props.value}
// //         </div>
...
//     }
//     getImageClass = () => this.state.open ? "notSelected" : "isSelected"
...
//     <div class= "container">
//         <div class="jumbotron">
//             <h1 class="display-5 text-center">FIND FIDO</h1>
//             <hr class="my-4"></hr>
...
//                                 <tbody>
//                                     <tr role= 'row'>
//                                         <td role='gridcell'> <img class={Selection[imageClass]} onClick={() => this.toggleImage} src= {shuffledDogs[0]} alt= "" /> </td>
